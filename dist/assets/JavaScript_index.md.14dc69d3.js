import{u as o,o as r,c as i,k as a,t as e,l as n,Q as c,a as s}from"./chunks/framework.fec3dccb.js";const d=c(`<h1 id="about-javascript" tabindex="-1">About JavaScript <a class="header-anchor" href="#about-javascript" aria-label="Permalink to &quot;About JavaScript&quot;">​</a></h1><p>This page is some interview questions about JavaScript.</p><p>The main <code>useData()</code> API can be used to access site, theme, and page data for the current page. It works in both <code>.md</code> and <code>.vue</code> files:</p><div class="language-md vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">md</span><pre class="shiki github-dark vp-code-dark"><code><span class="line"><span style="color:#E1E4E8;">&lt;script setup&gt;</span></span>
